...
export const blockRenderer = (block) => {
  ...
  switch (type) {
    case "paragraph":
      return (
        <p className="my-1 leading-snug" id={id}>
    ...
    case "heading_1":
      ...
      return (
        <h1 className="mt-3 mb-1 text-2xl font-bold md:text-3xl" id={id}>
          <RichTextRender richText={value.rich_text} />
        </h1>
      );
    case "heading_2":
      ...
      return (
        <h2 className="mt-3 mb-1 text-xl font-bold md:text-2xl" id={id}>
          <RichTextRender richText={value.rich_text} />
        </h2>
      );
    case "heading_3":
      ...
      return (
        <h3 className="mt-3 mb-1 text-lg font-bold md:text-xl" id={id}>
          <RichTextRender richText={value.rich_text} />
        </h3>
      );
